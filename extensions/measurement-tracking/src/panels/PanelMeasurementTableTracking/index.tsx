    ...
    UIDialogService.create({
      ...
      contentProps: {
        ...
        actions: [
          ...
          { id: 'cancel', text: t('Cancel'), type: 'primary' },
          { id: 'save', text: t('Save'), type: 'secondary' },
        ],
